...
static const char *fonts[]          = { "Dejavu Sans Mono:pixelsize=11" };
static const char dmenufont[]       = "Dejavu Sans Mono:pixelsize=11";
...
static Button buttons[] = {
	...
	{ ClkStatusText,        0,              Button2,        spawn,          { .v = alsamixercmd } },
	{ ClkStatusText,        0,              Button3,        spawn,          { .v = volumetogglecmd } },
	{ ClkStatusText,        0,              Button5,        spawn,          { .v = volumedowncmd } },
	{ ClkStatusText,        0,              Button4,        spawn,          { .v = volumeupcmd } },

	{ ClkWinTitle,          0,              Button4,        tagmon,         {.i = -1} },
	{ ClkWinTitle,          0,              Button5,        tagmon,         {.i = +1} },
